...
class VRMLLoader extends Loader {
	...
	parse(data, path) {
		...
		function createTokens() {
			...
			// from http://gun.teipir.gr/VRML-amgem/spec/parsrc/concepts.html#SyntaxBasics
			...
			// from http://gun.teipir.gr/VRML-amgem/spec/parsrc/nodesRef.html
		...
		function buildElevationGridNode(node) {
			...
			for (let i = 0; i < xDimension - 1; i++) {
				...
				for (let j = 0; j < zDimension - 1; j++) {
					...
					// from https://tecfa.unige.ch/guides/vrml/vrml97/spec/parsrc/nodesRef.html#ElevationGrid
